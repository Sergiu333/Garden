      ...
      <div className="flex flex-col xl:flex-row justify-between bg-about-us px-10">
        <div className="flex flex-col gap-[16px] justify-center">
          ...
          <div className="text-[16px] leading-[158%] text-[#FFFBFB] lg:w-[70%]">
            ...
            walking distance of Parks, and the best shopping, dining and entertainment Getting
            around is a breeze, with easy access to freeways, buses and trolleys. . Laundry is
            available on premises.
          </div>
          <Link href="/">
            <div className="text-[#1B1B1B] bg-[#FFFBFB] rounded-[8px] px-[24px] py-[12px] border font-semibold lg:w-fit">
              Read More
            </div>
          </Link>
        </div>
